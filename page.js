define( "ModalPage" , [ "Base" , "Template" , "RequireFile" , "ModalView" ] , function( Base , Template , RequireFile , ModalView ){
    ...
    var PageList 	= Base.extend( function( pageListId , $pageContainer , opt ){
        ...
        urlHistroyBack 	: function( backNum ){
            var _config 	= this._pageListConfig;
            backNum = _config.urlHistroy.length - ( backNum || 1 );
            if( backNum >= 0) {
                this[ _config.urlHistroy[ backNum - 1 ] || this._pageListConfig.originOpt.defaultHistroyPage ].display( function(){
                    _config.urlHistroy = _config.urlHistroy.slice( 0 , backNum );
                } );
            }
            return this;
        } 
        ...
        Page 	= Base.extend( function( belongPageList , jsPath , pageName ){
            ...
            getPageModal 		: function( func ){
                this._pageConfig.belongPageList._pageListConfig.urlHistroy.push( this._pageConfig.pageName );
